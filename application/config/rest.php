...
$config['rest_keys_table'] = 'customers';
$config['rest_keys_table'] = 'brands';
$config['rest_keys_table'] = 'categories';
$config['rest_keys_table'] = 'products';
...
$config['rest_key_column'] = 'name';
$config['rest_key_column'] = 'title';
