...
class CategoryController extends CI_Controller {
			...
			if ( ! $this->upload->do_upload('image'))
                {
					...
					$this->session->set_flashdata('success','Thêm danh mục sản phẩm thành công');
	...
	public function update($id){
		...
		if ($this->form_validation->run() == TRUE)
		{
			...
			$this->session->set_flashdata('success','Cập nhật danh mục sản phẩm thành công');
			redirect(base_url('category/list'));
		...
		public function delete($id){
			...
			$this->session->set_flashdata('success','Xóa danh mục sản phẩm thành công');
			redirect(base_url('category/list'));
		}
