...
class BrandController extends CI_Controller {
			...
			if ( ! $this->upload->do_upload('image'))
                {
					...
					$this->session->set_flashdata('success','Thêm bộ sưu tập thành công');
	...
	public function update($id){
		...
		if ($this->form_validation->run() == TRUE)
		{
			...
			$this->session->set_flashdata('success','Cập nhật bộ sưu tập thành công');
			redirect(base_url('brand/list'));
		...
		public function delete($id){
			...
			$this->session->set_flashdata('success','Xóa bộ sưu tập thành công');
			redirect(base_url('brand/list'));
		}
